...
const CourseDetails = () => {
  ...
  //     setCourseData(findCourse);
  //   } else {
  //     console.error("Course not found or allCourses not loaded");
  //   }
  // };
        ...
        bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            <div className="flex items-center gap-2">
              ...
              <p className="text-red-500">5 <span> left at this price!</span></p>
            </div>
          ...
          <div className="pt-6">
            ...
            <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500"> 
              ...
              <li>Step-by-step , hands-on project gudiance.</li>
