...
export const purchaseCourse = async (req, res) => {
  try {
    ...
    //---- Alternative for stripes-------/
    //Paystack Gateway Initialize
    //const paystackInstance = new Stripe(process.env.PAYSTACK_SECRET_KEY)
...
export const updateUserCourseProgress = async (req, res) => {
  try {
    ...
    //const courseProgress = await CourseProgress.findOneAndUpdate({ userId, courseId });
    const progressData = await CourseProgress.findOneAndUpdate({ userId, courseId });
